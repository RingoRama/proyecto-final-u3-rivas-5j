...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($nombre) && !empty($apellidos) && !empty($fecha_nac) && !empty($curp) && !empty($domicilio) ){
				$consulta_insert=$con->prepare('INSERT INTO empleados(nombre,apellidos,fecha_nac,curp,domicilio) VALUES(:nombre,:apellidos,:fecha_nac,:curp,:domicilio)');
...
<body>
	<div class="contenedor">
		...
		<form action="" method="post">
			...
			<div class="form-group">
				<input type="date" name="fecha_nac" class="input__text">
